...
async def register(user: UserCreate, db: AsyncSession = Depends(get_db)):
    ...
    access_token = create_access_token(data={"sub": new_user.username, "user_id":str(new_user.id), "email":new_user.email, "phone":new_user.phone_number, "password":new_user.hashed_password}, expires_delta=access_token_expires)
